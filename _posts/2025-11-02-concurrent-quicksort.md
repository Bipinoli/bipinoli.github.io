...
I realized I had never actually implemented quicksort before, and I was too proud to look up any examples, so it took me some time to figure out a good in-place solution for rearranging the numbers around the pivot. After [testing](https://github.com/Bipinoli/cpp-concurrency-in-action-notes/blob/main/chapter4_synchronizing_concurrent_operations/quick_sort/test.hpp) the implementation with randomly generated arrays, I was satisfied with the results and moved on to the concurrent version.


#### Step 2: Concurrent quicksort algorithm
[Link to the concurrent implementation](https://github.com/Bipinoli/cpp-concurrency-in-action-notes/blob/main/chapter4_synchronizing_concurrent_operations/quick_sort/concurrent.hpp)
