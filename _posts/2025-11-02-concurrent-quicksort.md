...
I realized I had never actually implemented quicksort before, and I was too proud to look up any examples, so it took me some time to figure out a good in-place solution for rearranging the numbers around the pivot. After [testing](https://github.com/Bipinoli/performance-focused-programming/tree/89f16df1ff8111fe852ec630e2ab2c3fbefda52d/quiksort_workers_multi_threaded/test.hpp) the implementation with randomly generated arrays, I was satisfied with the results and moved on to the concurrent version.


#### Step 2: Concurrent quicksort algorithm
[Link to the concurrent implementation](https://github.com/Bipinoli/performance-focused-programming/tree/89f16df1ff8111fe852ec630e2ab2c3fbefda52d/quiksort_workers_multi_threaded/concurrent.hpp)
